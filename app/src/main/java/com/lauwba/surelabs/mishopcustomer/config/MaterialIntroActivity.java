...
public abstract class MaterialIntroActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        permissionNotGrantedClickListener = new PermissionNotGrantedClickListener(MaterialIntroActivity.this, nextButtonTranslationWrapper);
        finishScreenClickListener = new MaterialIntroActivity.FinishScreenClickListener();
    ...
    private void initOnPageChangeListeners() {
        ...
        viewPager.addOnPageChangeListener(new ViewBehavioursOnPageChangeListener(adapter)
                ...
                .registerOnPageScrolled(new MaterialIntroActivity.ColorTransitionScrollListener())
